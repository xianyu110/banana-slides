...
from .template_controller import template_bp, user_template_bp, system_templates_bp
...
__all__ = ['project_bp', 'page_bp', 'template_bp', 'user_template_bp', 'system_templates_bp', 'export_bp', 'file_bp', 'material_bp', 'settings_bp']
